...
function setUp()
{
  cp --force 'tests/unit/samples/tag/patch_model.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_signed_off.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_full_review.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_reviewed.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_acked.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_fixes.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_tested.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_co_developed.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_reported.patch' "${SHUNIT_TMPDIR}/"
  cp --force 'tests/unit/samples/tag/patch_model_complete.patch' "${SHUNIT_TMPDIR}/"
...
function test_tag_patch_single_option()
{
  ...
  tag_main --add-signed-off-by='Jane Doe <janedoe@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_signed_off.patch'
  git restore patch_model.patch

  tag_main -s'Jane Doe <janedoe@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_signed_off.patch'
  git restore patch_model.patch

  tag_main --add-reviewed-by='Jane Doe <janedoe@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_reviewed.patch'
  git restore patch_model.patch

  tag_main -r'Jane Doe <janedoe@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_reviewed.patch'
  git restore patch_model.patch

  tag_main --add-acked-by='Michael Doe <michaeldoe@kwkw.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_acked.patch'
  git restore patch_model.patch

  tag_main -a'Michael Doe <michaeldoe@kwkw.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_acked.patch'
  git restore patch_model.patch

  tag_main --add-tested-by='Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_tested.patch'
  git restore patch_model.patch

  tag_main -t'Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_tested.patch'
  git restore patch_model.patch

  tag_main --add-co-developed-by='Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_co_developed.patch'
  git restore patch_model.patch

  tag_main -C'Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_co_developed.patch'
  git restore patch_model.patch

  tag_main --add-reported-by='Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_reported.patch'
  git restore patch_model.patch

  tag_main -R'Bob Brown <bob.brown@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_reported.patch'
  git restore patch_model.patch

  head2_msg="$(git rev-parse --short=12 HEAD~2) (\"fs: some_file: Fill file\")"

  tag_main --add-fixes='HEAD~2' patch_model.patch
  ...
  tag_main -f'HEAD~2' patch_model.patch
  sed --in-place "s/<hash>/${head2_msg}/g" patch_model_fixes.patch
  assertFileEquals 'patch_model.patch' 'patch_model_fixes.patch'
  git restore patch_model.patch patch_model_fixes.patch
}
...
function test_tag_patch_single_option_default()
{
  ...
  tag_main -s patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_signed_off.patch'
  git restore patch_model.patch

  tag_main -r patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_reviewed.patch'
  git restore patch_model.patch
  ...
  tag_main -t patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_tested.patch'
  git restore patch_model.patch

  tag_main -C patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_co_developed.patch'
  git restore patch_model.patch
...
function test_tag_patch_multi_options()
{
  ...
  tag_main -r'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_full_review.patch'
  git restore patch_model.patch
  ...
  tag_main --add-acked-by='Michael Doe <michaeldoe@kwkw.xyz>' patch_model.patch
  tag_main --add-reviewed-by='John Doe <johndoe@kwkw.xyz>' patch_model.patch
  tag_main --add-fixes='HEAD~2' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_complete.patch'
  git restore patch_model.patch

  tag_main -r'John Doe <johndoe@kwkw.xyz>' -a'Michael Doe <michaeldoe@kwkw.xyz>' -f'HEAD~2' patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_complete.patch'
  git restore patch_model.patch
  ...
  tag_main -r -s patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_full_review.patch'
  git restore patch_model.patch

  tag_main -s -r patch_model.patch
  assertFileEquals 'patch_model.patch' 'patch_model_full_review.patch'
  git restore patch_model.patch
}
...
function test_tag_patch_repetition_avoidance()
{
  ...
  output_msg="$(tag_main -s'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_signed_off.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Signed-off-by: Jane Doe <janedoe@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -r'Jane Doe <janedoe@mail.xyz>' -r'Jane Doe <janedoe@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_reviewed.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Reviewed-by: Jane Doe <janedoe@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -r'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' -r'Jane Doe <janedoe@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_full_review.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Reviewed-by: Jane Doe <janedoe@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -r'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_full_review.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Signed-off-by: Jane Doe <janedoe@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -a'Michael Doe <michaeldoe@kwkw.xyz>' -a'Michael Doe <michaeldoe@kwkw.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_acked.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Acked-by: Michael Doe <michaeldoe@kwkw.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -t'Bob Brown <bob.brown@mail.xyz>' -t'Bob Brown <bob.brown@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_tested.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Tested-by: Bob Brown <bob.brown@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -C'Bob Brown <bob.brown@mail.xyz>' -s'Bob Brown <bob.brown@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_co_developed.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Signed-off-by: Bob Brown <bob.brown@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -s'Bob Brown <bob.brown@mail.xyz>' -C'Bob Brown <bob.brown@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_co_developed.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Signed-off-by: Bob Brown <bob.brown@mail.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -R'Bob Brown <bob.brown@mail.xyz>' -R'Bob Brown <bob.brown@mail.xyz>' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_reported.patch'
...
function test_tag_patch_repetition_avoidance_default()
{
  ...
  output_msg="$(tag_main -r -a'Michael Doe <michaeldoe@kwkw.xyz>' -r -f'HEAD~2' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_complete.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Reviewed-by: John Doe <johndoe@kwkw.xyz>'" "$output_msg"
  git restore patch_model.patch

  output_msg="$(tag_main -r -a'Michael Doe <michaeldoe@kwkw.xyz>' -a'Michael Doe <michaeldoe@kwkw.xyz>' -f'HEAD~2' patch_model.patch)"
  assertFileEquals 'patch_model.patch' 'patch_model_complete.patch'
  assertEquals "(${LINENO})" "Skipping duplicated trailer line: 'Acked-by: Michael Doe <michaeldoe@kwkw.xyz>'" "$output_msg"
  git restore patch_model.patch
}
...
function test_tag_commit_single_option()
{
  ...
  tag_main -s'Jane Doe <janedoe@mail.xyz>'
...
function test_tag_commit_multi_options()
{
  ...
  tag_main -r'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>'
  current_log="$(git log --max-count 2 --format="%(trailers)")"
  assertEquals "(${LINENO})" "$CORRECT_FULL_REVIEW_HEAD" "$current_log"
  git reset --quiet --hard "$original_commit"

  tag_main -r'Jane Doe <janedoe@mail.xyz>' -s'Jane Doe <janedoe@mail.xyz>' HEAD~3
  current_log="$(git log --max-count 4 --format="%(trailers)")"
  assertEquals "(${LINENO})" "$CORRECT_FULL_REVIEW_LOG" "$current_log"
  git reset --quiet --hard "$original_commit"

  tag_main -a'Michael Doe <michaeldoe@kwkw.xyz>' -r'John Doe <johndoe@kwkw.xyz>' HEAD~3
  tag_main -f'HEAD~2'
  current_log="$(git log --max-count 4 --format="%(trailers)")"
  correct_fixed_value="$(git rev-parse --short=12 HEAD~2) (\"fs: some_file: Fill file\")"
  ...
  tag_main -R'Michael Doe <michaeldoe@mail.xyz>;Closes=http://link-to-bug.xyz.com' \
  ...
  tag_main -C'Michael Doe <michaeldoe@mail.xyz>' \
...
function test_tag_no_user_or_email_config()
{
  ...
  output_msg="$(tag_main --add-signed-off-by)"
  return_status="$?"
  ...
  output_msg="$(tag_main --add-reviewed-by)"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" \
  ...
  output_msg="$(tag_main --add-acked-by)"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" \
  ...
  output_msg="$(tag_main --add-tested-by)"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" \
  ...
  output_msg="$(tag_main --add-co-developed-by)"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" \
  ...
  output_msg="$(tag_main --add-reported-by)"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" \
...
function test_tag_invalid_tag_format()
{
  ...
  output_msg="$(tag_main --add-signed-off-by='Jane Doe <@mail.com>')"
  return_status="$?"
  expected_msg="$(printf 'Invalid email: @mail.com\nInvalid tag format: Jane Doe <@mail.com>')"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" "$expected_msg" "$output_msg"

  output_msg="$(tag_main --add-reviewed-by='<janedoe@mail.com>')"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" 'Invalid tag format: <janedoe@mail.com>' "$output_msg"

  output_msg="$(tag_main --add-acked-by='Jane Doe')"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" 'Invalid tag format: Jane Doe' "$output_msg"

  output_msg="$(tag_main --add-tested-by='Jane Doe janedoe@mail.com')"
  return_status="$?"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" 'Invalid tag format: Jane Doe janedoe@mail.com' "$output_msg"

  output_msg="$(tag_main --add-co-developed-by='Jane Doe <janedoe@mailcom>')"
  return_status="$?"
  expected_msg="$(printf 'Invalid email: janedoe@mailcom\nInvalid tag format: Jane Doe <janedoe@mailcom>')"
  assertEquals "(${LINENO})" 22 "$return_status"
  assertEquals "(${LINENO})" "$expected_msg" "$output_msg"
}
